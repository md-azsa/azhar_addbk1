...
public class AddressBook {
    ...
    private static final String MESSAGE_DISPLAY_PERSON_DATA = "%1$s\t\tPhone Number: %2$s\tEmail: %3$s\tD.O.B: %4$s";
    ...
    private static final String COMMAND_ADD_EXAMPLE = COMMAND_ADD_WORD + " John Doe p/98765432 e/johnd@gmail.com dob/DD.MM.YYYY";
    ...
    */
    ...
    //Added parameters for date of birth
    ...
    private static String extractNameFromPersonString(String encoded) {
        ...
        indexOfFirstPrefix = Math.min(indexOfFirstPrefix, indexOfDOBPrefix); //Comparing it with the new index of dob
